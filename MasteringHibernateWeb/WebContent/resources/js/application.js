$(document).ready(function() {
	...
	var personDataTable = $('#personTable').DataTable({
		'ajax': {url:'/MH/rest/person/list', dataSrc: 'person'},
		'columns': [
		          { data: 'id' },
		          { data: 'firstname' },
		          { data: 'lastname' },
	...
	$( document ).on('click', 'a.personIdLink', function(event) {
		...
		$.ajax({
			url: '/MH/rest/person/view/' + personId,
			dataType: 'json',
	...
	$( document ).on('click', 'a.personDeleteLink', function(event) {
		...
		$.ajax({
			url: '/MH/rest/person/delete/' + personId,
			type: 'GET',
			success: function(data, status, xhr) {
				refreshDataTable();
	...
	function refreshDataTable() {
		// personDataTable.ajax.url('/MH/rest/person/list').load();
